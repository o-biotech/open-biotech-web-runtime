      ...
      <div class='flex flex-wrap -mx-3 mb-4 text-left'>
        ...
        <div class='w-full p-3'>
          ...
          <p class='block text-md mb-8'>
            Data storage flows determine how device data can be processed and accessed.<br />

            <br />{' '}
            Cold flows enable long term storage with slower querying performance. Warm flows enable
            shorter term storage with better querying performance. Hot flows provide near real-time
            data (with no storage) and sync with your GitHub.
          </p>
